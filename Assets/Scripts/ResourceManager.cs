...
public class ResourceManager : MonoBehaviour
{
    ...
    void SpawnCube()
    {
        //cubeArray = new int[row][];
        //cubeArray = new Cube[row][];
        cubeHolder = new GameObject[row][];
        for (int i = 0 ; i < row ; i++)
        {
            //cubeArray[i] = new int[column];
            //cubeArray[i] = new Cube[column];
            ...
            for (int j = 0; j < column; j++)
            {
                ...
                //cubeArray[i, j].color = new int();
                //cubeArray[i, j].isCollectable = new bool();
                //cubeArray[i,j].color = 0;
                //cubeArray[i,j].isCollectable = false;
            }
        }
    }
                        ...
                        if (j >= 0 && j < column)
                        {
                            switch (cubeArray[i,j].color)
                            {
                                ...
                                case 3:
                                    ...
                                    break;
                                default:
                                    cubeHolder[i][j].GetComponent<Renderer>().material = normalMaterial;
                                    break;
                            }
                        }
                    }
