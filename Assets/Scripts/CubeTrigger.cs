...
public class CubeTrigger : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        if (GameManager.instance.currentState == GameState.SCAN && GameManager.instance.playerScanLimit > 0)
        {
            GameManager.instance.OnScanMineral(x, y);
        }
        if (GameManager.instance.currentState == GameState.COLLECT && GameManager.instance.playerCollectLimit > 0)
        {
